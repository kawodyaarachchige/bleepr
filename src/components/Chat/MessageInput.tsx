...
export const MessageInput: React.FC = () => {
    ...
    const { sendMessage, uploadProgress, setUserTyping } = useChat()
    const handleTyping = () => {
        setUserTyping(true)
        if (typingTimeout) {
            ...
            <div className="p-4 bg-black border-t border-indigo-600-100">
                ...
                <form onSubmit={handleSubmit} className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="px-4 py-2 text-white bg-blue-500 rounded-r-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
